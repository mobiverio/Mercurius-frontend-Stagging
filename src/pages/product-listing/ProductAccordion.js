    ...
    <main>
      ...
      <section class="bg-white">
        <div class="w-full mx-auto 2xl:max-w-7xl flex flex-col justify-center py-24  relative p-8">
          <div class="prose text-gray-500 prose-sm prose-headings:font-normal prose-headings:text-xl mx-auto w-full">
            <div>
              <h1>Accordion</h1>
              <p class="text-balance">
                Click on accordion items to see the content.
              </p>
            </div>
          </div>
          <div class="mt-6 border-t pt-12 max-w-xl mx-auto w-full">
            ...
            <div
              id="accordion"
              class="border rounded-md divide-y overflow-hidden"
            >
              {/* <!-- Accordion Item 1 --> */}
              <div>
                <button
                  id="accordionBtn1"
                  class="accordion-btn w-full flex justify-between items-center p-4 focus:outline-none text-gray-500 focus:text-blue-500"
                >
                ...
                <div
                  ...
                  class="accordion-content p-4 border-t text-sm bg-gray-50 text-gray-500 hidden"
                >
              ...
              <div>
                ...
                <div
                  ...
                  class="accordion-content p-4 text-gray-500 bg-gray-50 text-sm border-t hidden"
                >
          ...
          <div class="flex">
            <div class="flex flex-col divide-y divide-neutral-200">
              <div class="flex h-0 flex-1">
                <a
                  href="https://lexingtonthemes.com/tutorials/how-to-create-an-accordion-with-tailwind-css-and-javascript"
                  type="button"
              ...
              <div class="flex h-0 flex-1">
                <a
                  href="https://github.com/Lexington-Themes/lexington-tutorials/blob/main/src/pages/accordion-javascript/index.astro"
